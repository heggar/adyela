...
class CancelAppointmentUseCase:
    """Use case for canceling appointments."""
    ...
    async def execute(self, appointment_id: str, tenant_id: UUID) -> Appointment:
        ...
        Raises:
            ...
            BusinessRuleViolationError: If appointment cannot be cancelled
        """
        ...
        # Cancel (domain logic validates if cancellation is allowed)
        appointment.cancel()
