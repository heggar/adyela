...
@dataclass
class Appointment:
    """Appointment entity - Core business logic for appointments."""
    ...
    def is_upcoming(self) -> bool:
        ...
        return self.schedule.start > datetime.now(UTC) and self.status in [
    ...
    def from_dict(cls, data: dict[str, Any]) -> "Appointment":
        ...
        if isinstance(tenant_id_value, str):
            tenant_id = TenantId(UUID(tenant_id_value))
        else:
