...
/// Application configuration constants for professional app
class AppConfig {
  AppConfig._();

  // App Info
  static const String appName = 'Adyela Professional';
  ...
  static const String professionalIdKey = 'professional_id';
  ...
  static const Duration appointmentBufferTime = Duration(minutes: 15);
  ...
  // Dashboard
  static const int dashboardMetricsRefreshInterval = 300; // 5 minutes in seconds
  static const int upcomingAppointmentsLimit = 5;
}
